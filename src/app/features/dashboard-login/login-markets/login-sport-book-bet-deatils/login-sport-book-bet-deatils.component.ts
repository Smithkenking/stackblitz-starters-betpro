...
@Component({
  selector: '[app-login-sport-book-bet-deatils]',
  templateUrl: './login-sport-book-bet-deatils.component.html',
  styleUrls: ['./login-sport-book-bet-deatils.component.scss']
})
export class LoginSportBookBetDeatilsComponent implements OnInit, OnDestroy {
