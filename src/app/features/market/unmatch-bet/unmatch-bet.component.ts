...
@Component({
  selector: 'app-unmatch-bet',
  templateUrl: './unmatch-bet.component.html',
  styleUrls: ['./unmatch-bet.component.scss']
})
export class UnmatchBetComponent implements OnInit, OnDestroy {
  bets: MarketBet[];
